...
<div class="modal-header">
    <h4 class="modal-title"><?php echo $row_EditInf['inf_titulo']; ?></h4>
...
<div class="modal-body">
    <form>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $row_EditInf['inf_titulo']; ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="cite" class="col-sm-2 col-form-label">Cite</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="cite" id="cite" value="<?php echo $row_EditInf['inf_cite']; ?>">
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="para" id="para" >
                    ...
                    <?php do{ ?>
                    <option value="<?php echo $row_Funcionario['id_funcionario']; ?>" <?php if (!(strcmp($row_Funcionario['id_funcionario'], $row_EditInf['inf_para']))) {echo "selected";} ?>><?php echo $row_Funcionario['funcionario']; ?></option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="via" id="via">
                    ...
                    <?php do{ ?>
                    <option value="<?php echo $row_Inmediato['id_funcionario']; ?>" <?php if (!(strcmp($row_Inmediato['id_funcionario'], $row_EditInf['inf_via']))) {echo "selected";} ?>><?php echo $row_Inmediato['funcionario']; ?></option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="ref" id="ref" value="<?php echo $row_EditInf['inf_ref']; ?>">
            </div>
        </div>
        <div class="form-group row">
        ...
        <input type="hidden" name="id_inf" id="id_inf" value="<?php echo $id_inf_nota; ?>">
    </form>
</div>
<!-- Modal footer -->
<div class="modal-footer">
    <button type="button" class="btn btn-info" data-dismiss="modal" onclick="informeActualizar();">Actualizar</button>
